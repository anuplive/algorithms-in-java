package main.MovieTicketBooking.src.main.java.coding.challenge.cinema;
...
public class CinemaRoom {       
    ...
    private final Map<Map.Entry<LocalTime, LocalTime>, Movie> schedule = new HashMap<Map.Entry<LocalTime, LocalTime>, Movie>() {{
                put(new AbstractMap.SimpleEntry(LocalTime.of(9, 0), LocalTime.of(11, 0)), null);
                put(new AbstractMap.SimpleEntry(LocalTime.of(11, 0), LocalTime.of(13, 0)), null);
                put(new AbstractMap.SimpleEntry(LocalTime.of(13, 0), LocalTime.of(15, 0)), null);
                put(new AbstractMap.SimpleEntry(LocalTime.of(15, 0), LocalTime.of(17, 0)), null);
                put(new AbstractMap.SimpleEntry(LocalTime.of(17, 0), LocalTime.of(19, 0)), null);
                put(new AbstractMap.SimpleEntry(LocalTime.of(19, 0), LocalTime.of(21, 0)), null);
            }};
    ...
    private Entry<LocalTime, LocalTime> findFreeSlotInSchedule() { return null; }
